  ...
  <div class="modal-dialog" role="document">
	...
	<script type="text/javascript">
			...
			function build_emps_table(result){
				...
				var reportRecords = result.extend.pageInfo.list;
				$.each(reportRecords,function(index,item){
					...
					var voyageNumberTd = $("<td></td>").append(item.voyageNumber);
